    ...
    css = """
        <style>
            ...
            .nova-card {
                ...
                border-radius: 8px;
                padding: 16px;
                box-shadow: 0 14px 34px rgba(15, 23, 42, 0.14), inset 0 1px 0 rgba(255,255,255,0.06);
            ...
            .nova-signal {
                ...
                margin-top: 0.75rem;
                box-shadow: 0 18px 42px rgba(15, 23, 42, 0.18), inset 0 1px 0 rgba(255,255,255,0.06);
                backdrop-filter: blur(10px);
                overflow: visible;
                min-width: 0;
                overflow-wrap: anywhere;
            ...
            .nova-decision-grid {
                display: grid;
                grid-template-columns: minmax(190px, 0.78fr) minmax(280px, 1.15fr) minmax(320px, 1.35fr);
                gap: 14px;
                align-items: stretch;
                margin-top: 0.75rem;
            }
